"""
 SGD-QN, approximate 2nd order optimization method
"""
...
def sgd_qn(parameters,cost=None,gradients=None, stop=None,
    ...
    parameters: list or theano tensor
        List of parameters with respect to which SGD-QN should be applied
    ...
    lazy: boolean
        If it should use lazy evaluation or not
    stop : WRITE ME
    mylambda : WRITE ME
    t0 : WRITE ME
    skip : WRITE ME
    ...
    if lazy:
        from theano.ifelse import cond as ifelse
    else:
